        ...
        if settings["welcome"]:
            for u in message.new_chat_members:
                ...
                video="https://telegra.ph/file/03691465baa774e46506d.mp4",                                               
                                                 ...
                                                 reply_markup=InlineKeyboardMarkup( [ [ InlineKeyboardButton('🔥  ↭ Main Channel ↭  🔥', url='http://t.me/ExtraBotsUpdates') ],
                                                                                      [ InlineKeyboardButton('🔥  ↭ DEV ↭  🔥', url='http://t.me/NischayBots') ]
                                                                                    ] )
                )
...
async def leave_a_chat(bot, message):
    ...
    try:
        buttons = [[
            InlineKeyboardButton('𝚂𝚄𝙿𝙿𝙾𝚁𝚃', url=f'https://t.me/ExtraBotsUpdates')
        ]]
        reply_markup=InlineKeyboardMarkup(buttons)
