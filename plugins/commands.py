...
async def start(client, message):
    if message.chat.type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
        buttons = [
            [
                InlineKeyboardButton(' Subscribe ', url='https://www.youtube.com/@ExtraBots')
            ],
            [
                InlineKeyboardButton('⚡Updates⚡', url=f"https://telegram.me/ExtraBotsUpdates"),
            ],
            [
    ...
    if len(message.command) == 2 and message.command[1] in ["subscribe", "error", "okay", "help"]:
        buttons = [[
            ...
            InlineKeyboardButton('⚡ Updates ⚡', url=f"https://telegram.me/ExtraBotsUdates"),
            InlineKeyboardButton('🔔 Subscribe ', url='https://www.youtube.com/@ExtraBots')
            ],[
             InlineKeyboardButton('🙆🏻 Help 🦾', callback_data='help'),
            InlineKeyboardButton(' About Me  ', callback_data='about')
