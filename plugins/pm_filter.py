...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        buttons = [[
            ...
            InlineKeyboardButton('⚡Subscribe⚡', url=f"https://telegram.me/ExtraBotsUpdates"),
            InlineKeyboardButton('🤖 Updates 🤖', url='https://telegram.me/ExtraBotsUpdates')
            ],[
...
async def auto_filter(client, msg, spoll=False):
    ...
    btn.insert(0,
        [
            InlineKeyboardButton(text="⚡Join Our Channel⚡", url='https://telegram.me/ExtraBotsUpdates')
        ]
    )
